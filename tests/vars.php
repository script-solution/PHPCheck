...
?>';
	...
	public function testVars()
	{
		...
		self::assertEquals((string)new PC_Type(PC_Type::INT),(string)$global['$i4']);
		...
		self::assertEquals((string)new PC_Type(PC_Type::FLOAT),(string)$global['$f4']);
		self::assertEquals((string)new PC_Type(PC_Type::STRING,'"mystr"'),(string)$global['$s1']);
