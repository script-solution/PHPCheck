...
/**
 * The pagination for phpcheck. Determines the page-number automaticly.
 * 
 * @package			PHPCheck
 * @subpackage	src
 * @author			Nils Asmussen <nils@script-solution.de>
 */
class PC_Pagination extends FWS_Pagination
{
	/**
	 * Constructor
	 * 
	 ...
	 *
	 * @param PC_URL $url the URL-instance
	...
	public function populate_tpl($url)
	{
		...
		if(!($url instanceof PC_URL))
			FWS_Helper::def_error('instance','url','PC_URL',$url);;
